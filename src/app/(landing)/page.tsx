      ...
      <section className="relative bg-brand-25 pb-4">
        ...
        <div className="relative mx-auto">
          <MaxWidthWrapper className="relative">
            <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl lg:-m-4 lg:p-4">
              <MockDiscordUI>
                <AnimatedList>
                  <DiscordMessage
                  ...
                  <DiscordMessage
                    ...
                    avatarAlt="PingPanda Avatar"
                    username="PingPanda"
                    timestamp="Today at 2:47PM"
                    badgeText="Revenue"
                    badgeColor="#faa61a"
                    title="💰 Payment recieved"
                    content={{
                      amount: "$49.00",
                      email: "zoe.maritnez@gamil.com",
                      plan: "Pro",
                    }}
                  />
                  <DiscordMessage
                    ...
                    avatarAlt="PingPanda Avatar"
                    username="PingPanda"
                    timestamp="Today at 5:51AM"
                    badgeText="Milestone"
                    badgeColor="#5865f2"
                    title="🚀 Revenue milestone achieved"
                    content={{
                      recurringRevenue: "$5000.00 USD",
                      growth: "+8.2%",
                    }}
                  />
                </AnimatedList>
      ...
      <section className="relative py-24 sm:py-32 bg-white">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            ...
            <Heading className="text-center">What our customers are saying</Heading>
          </div>
