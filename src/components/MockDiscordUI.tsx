  ...
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-gray text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
        <div className="px-4 h-16 border-b border-[#202225] flex items-center shadow-md">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, index) => (
                <div
                  key={index}
                  className="flex items-center px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed"
                >
        ...
        <div className="p-2 bg-[#292b2f] flex items-center">
          ...
          <div className="flex-2">
            ...
            <p className="text-xs text-[#b9bbbe] felx items-center">
              @your_account
            </p>
          </div>

          <div className="flex item-center space-x-2 ml-2">
      ...
      <div className="flex flex-1 flex-col">
        ...
        {/* message history */}
        <div className="flex flex-col-reverse flex-1 overflow-y-auto p-4 bg-discord-gray">
          {children}
        </div>
