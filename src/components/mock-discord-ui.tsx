...
export const MockDiscordUI = ({ children }: MockDiscordUIProps) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex flex-col items-center w-[72px] bg-[#202225] py-3">
        ...
        <div className="group size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 mt-auto hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed">
